...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  ...
  if(GCC_VERSION VERSION_GREATER 4.7 OR GCC_VERSION VERSION_EQUAL 4.7)
    message(STATUS "Won't use just::thread in conjunction with gcc 4.7")
    return()
  elseif(GCC_VERSION VERSION_GREATER 4.6 OR GCC_VERSION VERSION_EQUAL 4.6)
    message ("gcc 4.6 is supported, using just threads ")
  else()
    message(STATUS "Won't use just::thread in conjunction with this compiler.")
    return()
  endif()
endif()
