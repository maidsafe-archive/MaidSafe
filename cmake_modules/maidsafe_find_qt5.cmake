...
if(WIN32)
  ...
  file(GLOB QtLibsRelease "${QT_BIN_DIR}/Qt5Core.dll" "${QT_BIN_DIR}/Qt5Concurrent.dll" "${QT_BIN_DIR}/Qt5Gui.dll" "${QT_BIN_DIR}/Qt5Widgets.dll" "${QT_BIN_DIR}/Qt5Network.dll" "${QT_BIN_DIR}/Qt5WebKit.dll" "${QT_BIN_DIR}/Qt5WebKitWidgets.dll")
  file(GLOB QtLibsDebug "${QT_BIN_DIR}/Qt5Cored.dll" "${QT_BIN_DIR}/Qt5Concurrentd.dll" "${QT_BIN_DIR}/Qt5Guid.dll" "${QT_BIN_DIR}/Qt5Widgetsd.dll" "${QT_BIN_DIR}/Qt5Networkd.dll" "${QT_BIN_DIR}/Qt5WebKitd.dll" "${QT_BIN_DIR}/Qt5WebKitWidgetsd.dll")
