...
if(IsLicenced)
  ...
  string(REGEX MATCH "5\\.[0-9]+\\.[0-9]+" CbfsVersion "${CbfsVersionLine}")
else()
  if(CMAKE_CL_64)
...
if(NOT EXISTS "${TempFolderName}/cbfs_changes.txt")
  file(DOWNLOAD https://www.eldos.com/files/files/cbfs5/changes.txt "${TempFolderName}/cbfs_changes.txt" TIMEOUT 10)
endif()
get_cbfs_version_from_file("${TempFolderName}/cbfs_changes.txt" LatestCbfsVersion)
