...
if(UNIX AND NOT APPLE)
  ...
  install(PROGRAMS ${PACKAGE_BINARY_DIR}/invigilator RENAME  lifestuff-mgr DESTINATION /usr/bin)
...
#    set(CPACK_RPM_PACKAGE_REQUIRES("libqtcore4 >= 4:4.7.2-0, libqtgui4 >= 4:4.7.2-0, libfuse2 >= 2.8.4-1")
    install(PROGRAMS ${private_SOURCE_DIR}/installer/linux/scripts/fedora/invigilator.service RENAME lifestuff-mgr.service DESTINATION /etc/systemd/user/)
    install(FILES ${lifestuff_gui_SOURCE_DIR}/src/maidsafe/lifestuff/qt_ui/resources/icons/app_icon_linux.png RENAME lifestuff.png DESTINATION /usr/share/maidsafe/lifestuff/resources/icons/)
    install(FILES ${lifestuff_gui_SOURCE_DIR}/src/maidsafe/lifestuff/qt_ui/resources/sounds/launch_lifestuff_gui.wav DESTINATION /usr/share/maidsafe/lifestuff/resources/sounds/)
    install(FILES ${lifestuff_gui_SOURCE_DIR}/src/maidsafe/lifestuff/qt_ui/resources/sounds/notification_alert.wav DESTINATION /usr/share/maidsafe/lifestuff/resources/sounds/)
...
elseif(WIN32)
  ...
  if(CMAKE_CL_64)
    set(CPACK_PACKAGE_FILE_NAME "${CPACK_NSIS_DISPLAY_NAME}-${CPACK_PACKAGE_VERSION}-${CMAKE_HOST_SYSTEM}-${CMAKE_HOST_SYSTEM_PROCESSOR}-64")
  else()
    set(CPACK_PACKAGE_FILE_NAME "${CPACK_NSIS_DISPLAY_NAME}-${CPACK_PACKAGE_VERSION}-${CMAKE_HOST_SYSTEM}-${CMAKE_HOST_SYSTEM_PROCESSOR}-32")
  endif()
endif()
