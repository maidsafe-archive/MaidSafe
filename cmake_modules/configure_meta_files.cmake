...
list(APPEND Variants "bool GetVariant(const maidsafe::nfs::TypeErasedMessageWrapper& message, T& variant);\n\n")
...
#  list(SORT ${DestinationPersona}ServiceMessages)
  ...
  list(APPEND Variant "bool GetVariant<${DestinationPersona}ServiceMessages>(\n")
