...
function(ms_add_executable EXE FOLDER_NAME)
  ...
  set_target_properties(${EXE} PROPERTIES LABELS ${CamelCaseProjectName} FOLDER "MaidSafe/Executables/${FOLDER_NAME}")
...
function(add_style_test)
  ...
  if(PYTHONINTERP_FOUND)
    ...
    if(UNIX)
      ...
      add_test(${ThisTestName} ${maidsafe_SOURCE_DIR}/tools/Windows/run_cpplint.bat ${STYLE_CHECK_SOURCE} ${maidsafe_SOURCE_DIR}/tools/hooks/windows/scripts/cpplint.exe)
    endif()
