...
foreach(Component ${BoostComponents})
  ...
  if("${Component}" STREQUAL "locale")
    ...
    elseif(UNIX)
      ...
      if(NOT Icui18nLib OR NOT IcuucLib)
        set(Msg "libicui18n.a and libicuuc.a must be installed to a standard location.  For ")
        set(Msg "${Msg}Ubuntu/Debian, run\n  sudo apt-get install libicu-dev")
        message(FATAL_ERROR "${Msg}")
      endif()
      set(Boost${CamelCaseComponent}Libs Boost${CamelCaseComponent} ${Icui18nLib} ${IcuucLib})
    else()
      set(Boost${CamelCaseComponent}Libs Boost${CamelCaseComponent})
    endif()
  endif()
