  ...
  if((${GTEST_NAME} MATCHES ${MAIDSAFE_TEST_TYPE}.+) OR (${MAIDSAFE_TEST_TYPE} MATCHES "ALL"))
    ...
    if(THIS_GTEST_EXCLUDED EQUAL -1)
      if("${GTEST_NAME}" MATCHES "^DISABLED_")
        ...
        add_test(NAME ${FULL_GTEST_NAME} COMMAND python ${CMAKE_SOURCE_DIR}/tools/run_test.py $<TARGET_FILE:${TEST_EXECUTABLE}> ${FULL_GTEST_NAME} ${CATCH_EXCEPTIONS} ${CMAKE_SOURCE_DIR})
      endif()
      ...
      if("${GTEST_NAME}" MATCHES "^FUNC_" OR "${GTEST_NAME}" MATCHES "^DISABLED_FUNC_")
        set_property(TEST ${FULL_GTEST_NAME} PROPERTY LABELS ${LabelName} Functional ${GTEST_FIXTURE_NAME})
      ...
      elseif("${GTEST_NAME}" MATCHES "^BEH_" OR "${GTEST_NAME}" MATCHES "^DISABLED_BEH_")
        set_property(TEST ${FULL_GTEST_NAME} PROPERTY LABELS ${LabelName} Behavioural ${GTEST_FIXTURE_NAME})
