  ...
  if((${GTEST_NAME} MATCHES ${MAIDSAFE_TEST_TYPE}.+) OR (${MAIDSAFE_TEST_TYPE} MATCHES "ALL"))
    ...
    if(THIS_GTEST_EXCLUDED EQUAL -1)
      if("${GTEST_NAME}" MATCHES "^DISABLED_")
        ...
        if(WIN32 AND ${CI_BUILD_ENVIRONMENT})
          add_test(NAME ${FULL_GTEST_NAME} COMMAND $<TARGET_FILE:${TEST_EXECUTABLE}> --gtest_filter=${FULL_GTEST_NAME} --gtest_catch_exceptions=1)
        else()
          add_test(NAME ${FULL_GTEST_NAME} COMMAND $<TARGET_FILE:${TEST_EXECUTABLE}> --gtest_filter=${FULL_GTEST_NAME})
        endif()
      endif()
