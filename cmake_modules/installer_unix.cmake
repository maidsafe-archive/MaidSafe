...
elseif("${TargetType}" STREQUAL "Dev")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/common/include/maidsafe" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/passport/include/maidsafe" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/rudp/include/maidsafe" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include//")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/routing/include/maidsafe" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/drive/include/maidsafe" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/encrypt/include/maidsafe" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/nfs/include/maidsafe" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/api/include/maidsafe" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/")
  file(COPY "${BoostSourceDir}/boost" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/boost/")
  file(GLOB CryptoHeaders "${SUPER_PROJECT_SOURCE_DIR}/src/third_party_libs/cryptopp/*.h")
  file(COPY ${CryptoHeaders} DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/cryptopp")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/third_party_libs/cereal" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/cereal")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/third_party_libs/sqlite/include/sqlite3.h" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/sqlite/")
  file(COPY "${SUPER_PROJECT_SOURCE_DIR}/src/third_party_libs/leveldb/include/" DESTINATION "${InstallerDir}/opt/maidsafe/usr/include/")
