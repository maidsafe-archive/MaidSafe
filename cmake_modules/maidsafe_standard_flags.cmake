...
set(APPLICATION_VERSION_PATCH 001)
...
# Testing environment if APPLICATION_VERSION_MINOR is odd
math(EXPR MAIDSAFE_TESTING ${APPLICATION_VERSION_MINOR}%2)
if(MAIDSAFE_TESTING)
...
elseif(UNIX)
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
    ...
    if (APPLE)
      ...
      set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -fdiagnostics-format=clang -fdiagnostics-show-option -fdiagnostics-fixit-info -ftrapv -fcatch-undefined-behavior -faddress-sanitizer")
    endif()
