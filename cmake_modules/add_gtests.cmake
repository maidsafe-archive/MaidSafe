...
function(ms_add_gtests TEST_TARGET)
  ...
  if(NOT PRIVATE_TEST_TIMEOUT)
    set(PRIVATE_TEST_TIMEOUT 10)
  endif()
...
function(add_maidsafe_test GTEST_FIXTURE_NAME GTEST_NAME FULL_GTEST_NAME TEST_EXECUTABLE)
  if((${GTEST_NAME} MATCHES ${MAIDSAFE_TEST_TYPE}.+) OR (${MAIDSAFE_TEST_TYPE} MATCHES "ALL"))
    ...
    if(THIS_GTEST_EXCLUDED EQUAL -1)
      ...
      elseif("${GTEST_NAME}" MATCHES "^PRIV_" OR "${GTEST_NAME}" MATCHES "^DISABLED_PRIV_")
        set_property(TEST ${FULL_GTEST_NAME} PROPERTY LABELS ${CamelCaseProjectName} Private)
        ms_update_test_timeout(PRIVATE_TEST_TIMEOUT)
        set_property(TEST ${FULL_GTEST_NAME} PROPERTY TIMEOUT ${PRIVATE_TEST_TIMEOUT})
