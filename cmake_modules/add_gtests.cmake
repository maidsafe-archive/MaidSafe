  ...
  foreach(Registered ${Registereds})
    ...
    foreach(GtestName ${GtestNames})
      foreach(TypeParameter ${${GtestFixtureName}TypeParameters})
        ...
        add_maidsafe_test(${GtestFixtureName} ${GtestName} ${FullGtestName})
      endforeach()
    endforeach()
  endforeach()
  set(AllGtests ${AllGtests} PARENT_SCOPE)
...
function(add_gtest_non_type_parameterised FileContents TestTarget)
  ...
  foreach(GtestName ${GtestNames})
    ...
    elseif(NOT GtestTestType MATCHES "^TYPED_TEST_P$")  # Others, excluding type-parameterised tests
      add_maidsafe_test(${GtestFixtureName} ${GtestName} ${GtestFixtureName}.${GtestName})
    endif()
  endforeach()
  set(AllGtests ${AllGtests} PARENT_SCOPE)
endfunction()
...
function(add_maidsafe_test GtestFixtureName GtestName FullGtestName)
  if((GtestName MATCHES "${MAIDSAFE_TEST_TYPE}.+") OR (MAIDSAFE_TEST_TYPE MATCHES "ALL")
      OR ((MAIDSAFE_TEST_TYPE MATCHES "UNIT") AND ((GtestName MATCHES "BEH.+") OR (GtestName MATCHES "FUNC.+"))))
    add_disabled_test()
  ...
  if(GtestName MATCHES "^FUNC_" OR GtestName MATCHES "^DISABLED_FUNC_")
    if((MAIDSAFE_TEST_TYPE MATCHES "ALL") OR (MAIDSAFE_TEST_TYPE MATCHES "UNIT") OR (MAIDSAFE_TEST_TYPE MATCHES "FUNC"))
#      message("Functional test  ${GtestName} for MS_TEST_TYPE ${MAIDSAFE_TEST_TYPE}.")
  ...
  elseif(GtestName MATCHES "^BEH_" OR GtestName MATCHES "^DISABLED_BEH_")
    if((MAIDSAFE_TEST_TYPE MATCHES "ALL") OR (MAIDSAFE_TEST_TYPE MATCHES "UNIT") OR (MAIDSAFE_TEST_TYPE MATCHES "BEH"))
#      message("Behavioral test  ${GtestName} for MS_TEST_TYPE ${MAIDSAFE_TEST_TYPE}.")
  ...
  elseif(GtestName MATCHES "^NETWORK_" OR GtestName MATCHES "^DISABLED_NETWORK_")
    if((MAIDSAFE_TEST_TYPE MATCHES "ALL") OR (MAIDSAFE_TEST_TYPE MATCHES "NETWORK"))
 #     message("Network test  ${GtestName} for MS_TEST_TYPE ${MAIDSAFE_TEST_TYPE}.")
