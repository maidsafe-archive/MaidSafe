...
if(WIN32)
  ...
  find_package(Qt4 4.8.1 COMPONENTS ${MS_QT_REQUIRED_LIBRARIES} REQUIRED)
endif()
include(${QT_USE_FILE})
...
if(WIN32)
  ...
  file(GLOB QtLibsRelease "${QT_ROOT_DIR}/bin/QtCore4.dll" "${QT_ROOT_DIR}/bin/QtGui4.dll" "${QT_ROOT_DIR}/bin/QtNetwork4.dll" "${QT_ROOT_DIR}/bin/QtWebKit4.dll")
  file(GLOB QtLibsDebug "${QT_ROOT_DIR}/bin/QtCored4.dll" "${QT_ROOT_DIR}/bin/QtGuid4.dll" "${QT_ROOT_DIR}/bin/QtNetworkd4.dll" "${QT_ROOT_DIR}/bin/QtWebKitd4.dll")
