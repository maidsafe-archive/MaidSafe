...
if(NOT ANDROID_DEVICE_ARCH)
  set(ErrorMessage "\n\nCan't find ANDROID_DEVICE_ARCH. ")
  set(ErrorMessage "${ErrorMessage}To set it, run:\n")
  set(ErrorMessage "${ErrorMessage}    cmake . -DANDROID_DEVICE_ARCH=armv7-a\n\n")
  message(FATAL_ERROR "${ErrorMessage}")
endif()
...
if(NOT ANDROID_GCC_VERSION)
  set(ErrorMessage "\n\nCan't find TOOLCHAIN_GCC_VERSION. ")
  set(ErrorMessage "${ErrorMessage}To set it, run:\n")
...
if(ANDROID_API_LEVEL LESS 16)
  ...
  set(ExeLinkerFlags "-pie -rdynamic")
endif()
...
set(CMAKE_C_FLAGS "${PLATFORM_FLAGS} -march=${ANDROID_DEVICE_ARCH} -mfloat-abi=softfp -mfpu=neon" CACHE STRING "")
set(CMAKE_CXX_FLAGS "${PLATFORM_FLAGS} -march=${ANDROID_DEVICE_ARCH} -mfloat-abi=softfp -mfpu=neon" CACHE STRING "")
