...
file(GLOB AVAILABLE_VERSIONFILES 
  RELATIVE ${CWD} 
  "/usr/local/share/boost-*/cmake/BoostConfig.cmake")

message("globbed: ${AVAILABLE_VERSIONFILES}")
if (EXISTS "/usr/local/share/boost-${PACKAGE_FIND_VERSION_MAJOR}.${PACKAGE_FIND_VERSION_MINOR}.${PACKAGE_FIND_VERSION_PATCH}/cmake/BoostConfig.cmake")
  #
  #  Exact version
  #
